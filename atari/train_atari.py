...
# parser.add_argument('--data_dir_prefix', type=str, default='../../autodl-fs/.sys/tmp/data_atari/',
#                     help='Path to dataset (default: "../../autodl-fs/.sys/tmp/data_atari/", must include the last slash "/")')
...
#                     help='Choose one of "attn", "conv", "conv-attn", "rwkv6", "mamba-min" or "mamba" (default: "mamba")')
parser.add_argument('--token_mixer', type=str, default='rwkv6',
                    help='Choose one of "attn", "conv", "conv-attn", "rwkv6", "mamba-min" or "mamba" (default: "mamba")')
...
def main():
    ...
    mconf = GPTConfig(
        ...
        head_size_a = 64, # don't change, for rwkv
        head_size_divisor = 8, # don't change, for rwkv
        dim_att = args.n_embd, # for rwkv
        dim_ffn = int((args.n_embd * 3.5) // 32 * 32), # for rwkv 
        )
    model = GPT(mconf)
